...
# 华为昇腾NPU版本的nanochat训练脚本 - 修复版
# Huawei Ascend NPU version of nanochat training pipeline - Fixed

set -e  # 出错时退出

echo "=== NanoChat NPU Training Pipeline (Fixed) ==="
echo "华为昇腾NPU训练管道开始..."
...
# 修复的batch size配置：
# max_seq_len=2048, device_batch_size=256, world_size=4
# world_tokens_per_fwdbwd = 256 * 2048 * 4 = 2,097,152
# total_batch_size必须是world_tokens_per_fwdbwd的倍数
